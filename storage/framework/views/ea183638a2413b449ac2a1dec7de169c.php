                                ...
                                <div class="card" id="customerList">
                                    <div class="card-header border-bottom-dashed">
                                        <div class="d-flex">
                                            ...
                                            <div class="col-sm-auto">
                                                <div class="d-flex gap-1 flex-wrap">
                                                    <a href="<?php echo e(route('offices.index')); ?>" class="btn btn-success add-btn"><i
                                                            class="ri-eye-fill align-bottom me-1"></i> View All
                                                    </a>
                                                </div>
                                            </div>
...
<?php echo $__env->make('admin.layout.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\personal\InHouse-web\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>