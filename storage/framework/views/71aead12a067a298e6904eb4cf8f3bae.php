<?php $__env->startSection('title','InHouse | Admin Dashboard'); ?>
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="col-sm-auto">
                                                <div class="d-flex gap-1 flex-wrap">
                                                    <a href="<?php echo e(route('employee')); ?>" class="btn btn-success add-btn"><i
                                ...
                                <div class="card" id="customerList">
                                    <div class="card-header border-bottom-dashed">
                                        <div class="d-flex">
                                            ...
                                            <div class="col-sm-auto">
                                                <div class="d-flex gap-1 flex-wrap">
                                                    <a href="<?php echo e(route('offices')); ?>" class="btn btn-success add-btn"><i
                                                            class="ri-eye-fill align-bottom me-1"></i> View All
                                                    </a>
                                                </div>
                                            </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="flex-shrink-0">
                                                                    <img
                                                                        src="<?php echo e(asset('dashboard_assets/assets/images/users/avatar-1.jpg')); ?>"
                                                                        alt=""
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="flex-shrink-0">
                                                                    <img
                                                                        src="<?php echo e(asset('dashboard_assets/assets/images/users/avatar-2.jpg')); ?>"
                                                                        alt=""
                                                                        class="avatar-xxs rounded-circle image_src object-fit-cover">
                                                                </div>
...
<?php $__env->startSection('custom-script'); ?>
    ...
    <!-- Dashboard init -->
    <script src="<?php echo e(asset('dashboard_assets/assets/js/pages/dashboard-ecommerce.init.js')); ?>"></script>
    <!-- Dashboard init -->
    <script src="<?php echo e(asset('dashboard_assets/assets/js/pages/dashboard-crm.init.js')); ?>"></script>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('admin.layout.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HS LAPTOP\Downloads\2024 Downloads Sep\InHouse-web\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>