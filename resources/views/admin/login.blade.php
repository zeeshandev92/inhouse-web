...
<html lang="en" data-layout="vertical" data-topbar="light" data-sidebar="dark" data-sidebar-size="lg"
    data-sidebar-image="none" data-preloader="disable" data-theme="default" data-theme-colors="red">
...
<head>
    ...
    <!-- Layout config Js -->
    <script src="{{ asset('dashboard_assets/assets/js/layout.js') }}"></script>
    <!-- Bootstrap Css -->
    ...
    <!-- custom Css-->
    <link href="{{ asset('dashboard_assets/assets/css/custom.min.css') }}" rel="stylesheet" type="text/css" />
...
<body>
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    <a href="javascript:void(0)" class="d-inline-block auth-logo mb-3">
                                        <img src="{{ asset('dashboard_assets/assets/images/logo.png') }}" alt=""
                                            height="120">
                                    </a>
    ...
    <script src="{{ asset('dashboard_assets/assets/libs/feather-icons/feather.min.js') }}"></script>
    <script src="{{ asset('dashboard_assets/assets/js/pages/plugins/lord-icon-2.1.0.js') }}"></script>
    <script src="{{ asset('dashboard_assets/assets/js/plugins.js') }}"></script>

    <!-- particles js -->
    <script src="{{ asset('dashboard_assets/assets/libs/particles.js/particles.js') }}"></script>
    <!-- particles app js -->
    <script src="{{ asset('dashboard_assets/assets/js/pages/particles.app.js') }}"></script>
    <!-- password-addon init -->
    <script src="{{ asset('dashboard_assets/assets/js/pages/password-addon.init.js') }}"></script>
</body>
