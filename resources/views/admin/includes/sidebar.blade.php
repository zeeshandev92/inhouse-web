...
<div class="app-menu navbar-menu">
    ...
    <div class="navbar-brand-box">
        ...
        <a href="/" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="{{asset('dashboard_assets/assets/images/logo-sm.png')}}" alt="" height="22">
                    </span>
            <span class="logo-lg">
                        <img src="{{asset('dashboard_assets/assets/images/logo.png')}}" alt="" height="90">
                    </span>
        </a>
        <!-- Light Logo-->
                ...
                aria-haspopup="true" aria-expanded="false">
                    <span class="d-flex align-items-center gap-2">
                        <img class="rounded header-profile-user"
                             src="{{asset('dashboard_assets/assets/images/users/avatar-1.jpg')}}" alt="Header Avatar">
    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="{{route('analytics')}}">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="{{route('drivers')}}">
                        <i class="ri-car-fill"></i> <span data-key="t-authentication">Drivers</span>
                    </a>
                </li>

                <li class="nav-item">
                    <a class="nav-link menu-link" href="{{route('offices')}}">
