        ...
        if (e == e) {
            ...
            switch (e["data-theme-colors"]) {
                ...
                case "blue":
                    ...
                    break;
				case "red":
                    T("data-theme-colors", "red"), sessionStorage.setItem("data-theme-colors", "red"), document.documentElement.setAttribute("data-theme-colors", "red");
                    break;
                default:
                    T("data-theme-colors", "default"), sessionStorage.setItem("data-theme-colors", "default"), document.documentElement.setAttribute("data-theme-colors", "default");
            }
    ...
    sessionStorage.getItem("defaultAttribute")
        ...
        (z = document.querySelectorAll(".light-dark-mode")) &&
            ...
            z[0].addEventListener("click", function (e) {
                k.hasAttribute("data-bs-theme") && "dark" == k.getAttribute("data-bs-theme") ? C("data-bs-theme", "light", "layout-mode-light", k , "data-sidebar" , "light") : C("data-bs-theme", "dark", "layout-mode-dark", k , "data-sidebar" , "dark"), window.dispatchEvent(x);
            }),
        G(),
        D(),
        m(),
