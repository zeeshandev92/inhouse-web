...
var worldemapmarkers = "", storeVisitsSourceChart = "", customerImpressionChart = "";
...
function loadCharts() {
    ...
    t && (document.getElementById("sales-by-locations").innerHTML = "", worldemapmarkers = "", worldemapmarkers = new jsVectorMap({
        ...
        zoomButtons: !1,
        selectedMarkers: [0, 5],
        regionStyle: {initial: {stroke: "#9599ad", strokeWidth: .25, fill: t[0], fillOpacity: 1}},
        markersSelectable: !0,
        ...
        }, {name: "Inactive", type: "line", data: [8, 12, 7, 17, 21, 11, 5, 9, 7, 29, 12, 35]}],
