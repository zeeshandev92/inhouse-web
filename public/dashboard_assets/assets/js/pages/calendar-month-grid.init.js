    ...
    e.sort(function (e, t) {
        ...
        var a = e.start,
            d = (a = "Invalid Date" === a || void 0 === a ? null : (d = new Date(a).toLocaleDateString("en", {
                ...
                month: "short",
                year: "numeric"
            }).split(" ").join(" ")), n ? " to " + n : ""), n = e.className.split("-"), l = e.description || "",
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    var r = new Choices("#event-category", {searchEnabled: !1}), b = new FullCalendar.Calendar(e, {
        timeZone: "local",
        editable: !0,
        droppable: !0,
        selectable: !0,
    ...
    b.render(), upcomingEvent(y), i.addEventListener("submit", function (e) {
        ...
        var t, n, e = document.getElementById("event-title").value, a = document.getElementById("event-category").value,
            d = document.getElementById("event-start-date").value.split("to"), l = new Date(d[0].trim()),
            i = new Date(d[1]), i = (i.setDate(i.getDate() + 1), d[1] ? i : ""), o = null,
