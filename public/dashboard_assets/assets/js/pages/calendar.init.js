...
document.addEventListener("DOMContentLoaded", function () {
    ...
    var g = new bootstrap.Modal(document.getElementById("event-modal"), {keyboard: !1}),
        ...
        y = [{id: 1, title: "Introduction to HVAC Systems", start: "2022-01-04", className: "bg-info-subtle", allDay: !0}, {
            id: 2,
            ...
            id: 3,
            title: "HVAC Terms and Definitions",
            start: "2022-02-21",
            className: "bg-info-subtle",
            allDay: !0
        }, {
            id: 4,
            title: "HVAC Component Specifications",
            start: "2022-03-08",
            className: "bg-info-subtle",
            allDay: !0
        }, {id: 5, title: "Best Practices in Customer Service", start: "2022-02-22", className: "bg-info-subtle", allDay: !0}, {
            id: 6,
            title: "Installation Skills",
            start: "2022-03-21",
            className: "bg-info-subtle",
            allDay: !0
        }, {id: 7, title: "Advanced Maintenance Practices", start: "2022-03-22", className: "bg-info-subtle", allDay: !0}, {
            id: 8,
            ...
            allDay: !0,
            extendedProps: {department: "License Expiry"},
            ...
            extendedProps: {department: "License Expiry"},
            description: "A recurring or License Expiry is simply any event that you will occur more than once on your calendar. "
        }, {
            id: 112,
            title: "Vehicle Maintenance",
